...
#+begin_src emacs-lisp
      ...
      ;; adding custom environment for unnambered equation
        (setq cdlatex-env-alist
            '(("equation*" "\\begin{equation*}\nAUTOLABEL\n?\n\\end{equation*}\n" nil)))

  ;; sets a custom symbol for math symbol insertion (corresponds to the keys combination "M-ù" on an italian MacOS keyboard
    ;; (setq cdlatex-math-symbol-prefix 248)
#+end_src
