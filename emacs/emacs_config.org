...
#+begin_src emacs-lisp
        ...
        (setq bibtex-completion-notes-path "~/Dropbox/myannotations/Zotero")
...
#+begin_src emacs-lisp
  ...
  (setq org-ref-default-bibliography '("~/Desktop/global_library.bib")
        org-ref-bibliography-notes "~/Dropbox/myannotations/Zotero"
...
** TODO See if there's any way to include Zotero tags in the bibliographic search
** TODO Try to understand why when finding with ivy-bibtex a document that also contains annotations it is not possible to open the annotations
