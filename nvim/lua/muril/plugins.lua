...
return require('packer').startup(function(use)
    ...
    --
    use 'mbbill/undotree'
    use {'glts/vim-radical',                --for istantaneously converting between numerical representations
        requires = {'glts/vim-magnum'}      --bigint library for VIM - dependency of vim-radical
    }
